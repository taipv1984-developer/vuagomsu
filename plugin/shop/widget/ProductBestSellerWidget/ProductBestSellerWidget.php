...
class ProductBestSellerWidget{
	...
	function __construct($layoutWidgetInfo){
		...
		$this->settingDefault = array(
			...
			'style' => array(
				...
				'style2' => 'style2 (Giao diện hiển thị ở trang sản phẩm)',
			),
			'items_limit' => '10',
		);
	}
    ...
    public function form(){
   	...
   	public function view(){
   		...
   		//add info
   		$setting['productList'] = ProductExt::getProductBestSellersList($this->settingDefault['items_limit']);
