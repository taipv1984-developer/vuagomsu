	...
	<table class="table table-striped table-bordered table-hover dataTable no-footer">
		...
		<tbody>
			...
			<tr id="row_<?php echo $v['attributeValueId']?>" class="row_<?php echo $v['attributeValueId']?>">
				<td>
					<?php 
						TemplateHelper::getTemplate('common/input/file.php', array(
							...
							'value' => URLHelper::getImagePath($v['image'], 'small')
						));
					?>
				</td>
				...
				<td>
					<div class="price"><?php echo ProductExt::getPriceText($v['price']);?></div>
				</td>
				<td>
					<?php echo $v['quantity']?>
				</td>
				<td>
					<div class="price price_total"><?php echo ProductExt::getPriceText($v['priceTotal']); ?></div>
				</td>
			</tr>
		<?php }?>
		</tbody>
		...
		<ul>
			...
			<li>
				...
				<strong class="price subTotal">
					<?php echo CurrencyExt::format_price($cartInfo['subTotal']); ?>
				</strong>
			</li>
			<!-- shipping price -->
			<li>
				...
				<strong class="price">
					<?php echo CurrencyExt::format_price($shippingPrice); ?>
				</strong>
			</li>
			...
			<li>
				...
				<strong class="price">
					<?php echo CurrencyExt::format_price($v->value); ?>
				</strong>
			</li>
			<?php }?>
			<!-- total -->
			<li class="total_price">
				...
				<strong class="price">
					<?php echo CurrencyExt::format_price($total); ?>
				</strong>
			</li>
		</ul>
	</div>
