...
class CurlClientTest extends TestCase
{
    ...
    public function testDefaultOptions()
    {
        ...
        $withOptionsArray = new urlClient($optionsArray);
        ...
        $ref = null;
        $withClosure = new urlClient(function ($method, $absUrl, $headers, $params, $hasFile) use (&$ref) {
            $ref = func_get_args();
            return array();
        });
        ...
        $withBadClosure = new urlClient(function () {
