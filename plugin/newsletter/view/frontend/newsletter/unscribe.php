		...
		<tbody>
			<tr>
				<td class="tdContentBody" style="padding-bottom: 50px">
					<h1 style="margin-top: 20px"><?php echo e("Thank You")?>!</h1> <?php echo e("You have been unsubscribed from this publication")?>.
					<ul>
						<li><?php echo e("If you wish to resubscribe to emails from")?> <span style="color: #555555;"><b><?php echo Registry::getSetting("site_name")?></b></span>, <?php echo e("click")?> <a href="<?php echo URLHelper::getUrl("home/resubscribe_newsletter",array('random_profile'=>$_REQUEST['random_profile']))?>"><?php echo e("Resubscribe")?></a></li>
