		...
		<div class="m-b-lg">
			...
			<form action="" method="post" name="form" class="form-validation ng-invalid ng-dirty ng-invalid-email ng-valid-parse ng-valid-required">
				...
				<div class="text-center m-t m-b">
					...
					<a href="<?=URLHelper::getUrl('home/forget_password')?>" class="popup50">
						Lấy lại mật khẩu
					</a>
				</div>
				...
				<a class="btn btn-lg btn-default btn-block" href="<?=URLHelper::getUrl('home/register')?>">Đăng ký tài khoản</a>
				<div class="line line-dashed"></div>
