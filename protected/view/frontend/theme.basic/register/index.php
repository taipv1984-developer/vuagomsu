...
?>
<!-- datepicker -->
<script src="<?="$baseUrl/resource/frontend/$templateName"?>/js/bootstrap-datepicker/js/bootstrap-datepicker.js" type="text/javascript"></script>
<link href="<?="$baseUrl/resource/frontend/$templateName"?>/js/bootstrap-datepicker/css/datepicker.css" rel="stylesheet" type="text/css"/>
