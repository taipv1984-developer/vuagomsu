<section id="signIn" class="form-sign ng-scope">
	<div class="container w-xxl w-auto-xs ng-scope">
		<a class="logo-brand block text-center" href="<?php echo URLHelper::getUrl('home')?>">
			<img src="<?php echo Registry::getSetting('logo')?>"
				title="<?php echo Registry::getSetting('site_name')?>" alt="<?php echo Registry::getSetting('site_name')?>">
		</a>
		<div class="m-b-lg">
