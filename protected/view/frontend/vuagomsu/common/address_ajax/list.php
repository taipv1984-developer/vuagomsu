...
<script type="text/javascript">
	$('<?php echo "#".$country['id'] ?>').change(function(){
		var object = '<?php echo $country['id'] ?>';
	    ...
	    console.log('coutry click ...<?php echo $url ?>');
	    $.ajax({
	        url: '<?php echo $url ?>',
	        type: 'post',
	        data:{'object': object, 
	        ...
	        success: function(data){
	        	 console.log(data);
	            $('#country_ajax_zone_<?php echo $country['id'] ?>').html(data);
	       },
