...
class PHPMailer
{
     ...
     * Clients that can read HTML will view1 the normal Body.
     * @type string
     */
    public $AltBody = '';
    ...
    /**
     * The array of available language.
     * @type array
     * @access protected
     */
    ...
    public function msgHTML($message, $basedir = '', $advanced = false)
   {
        ...
        if(empty($this->AltBody)){
            $this->AltBody = 'To view1 this email message, open it in a program that understands HTML!' .
                self::CRLF . self::CRLF;
       }
        return $this->Body;
   }
