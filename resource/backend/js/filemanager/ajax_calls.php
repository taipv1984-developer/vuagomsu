    ...
    switch($_GET['action'])
    {
		...
		case 'save_img':
			...
			create_img(
				...
				$thumbs_base_path.$_POST['path'].$_POST['name'], 
				$my_thumbnail_config['image_medium']['width'], 
				$my_thumbnail_config['image_medium']['height'], 
				$my_thumbnail_config['option_resize']); //ZPham
