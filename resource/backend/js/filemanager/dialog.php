			...
			$file=$file_array['file'];
			    ...
			    try {
			    	...
			    	if(!create_img(
						$file_path, 
						$src_thumb, 
						$my_thumbnail_config['image_max']['width'], 
						$my_thumbnail_config['image_max']['height'], 
						$my_thumbnail_config['option_resize'])
            		){	//ZPham
							$src_thumb=$mini_src="";
						}else{
				...
				if($img_width < $my_thumbnail_config['image_max']['width'] && $img_height < $my_thumbnail_config['image_max']['height']){
